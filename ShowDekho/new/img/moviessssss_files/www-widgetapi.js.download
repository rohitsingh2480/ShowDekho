...
q=Tc.prototype;q.has=function(a){return Wc(this.i,a)};
q.equals=function(a,b){if(this===a)return!0;if(this.size!=a.size)return!1;b=b||Xc;Vc(this);for(var c,d=0;c=this.h[d];d++)if(!b(this.get(c),a.get(c)))return!1;return!0};
function Xc(a,b){return a===b}
q.isEmpty=function(){return 0==this.size};
q.clear=function(){this.i={};this.j=this.size=this.h.length=0};
q.remove=function(a){return this.delete(a)};
q.delete=function(a){return Wc(this.i,a)?(delete this.i[a],--this.size,this.j++,this.h.length>2*this.size&&Vc(this),!0):!1};
...
q.get=function(a,b){return Wc(this.i,a)?this.i[a]:b};
q.set=function(a,b){Wc(this.i,a)||(this.size+=1,this.h.push(a),this.j++);this.i[a]=b};
q.forEach=function(a,b){for(var c=Uc(this),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
q.clone=function(){return new Tc(this)};
q.keys=function(){return Oc(this.C(!0)).h()};
q.values=function(){return Oc(this.C(!1)).h()};
q.entries=function(){var a=this;return Dc(this.keys(),function(b){return[b,a.get(b)]})};
q.C=function(a){Vc(this);var b=0,c=this.j,d=this,e=new Nc;e.next=function(){if(c!=d.j)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw Mc;var f=d.h[b++];return a?f:d.i[f]};
return e};
...
G(P,Lc);q=P.prototype;q.subscribe=function(a,b,c){var d=this.i[a];d||(d=this.i[a]=[]);var e=this.o;this.h[e]=a;this.h[e+1]=b;this.h[e+2]=c;this.o=e+3;d.push(e);return e};
...
q.R=function(){P.G.R.call(this);this.clear();this.j.length=0};function Qd(a){this.h=a}
...
G(Xd,Wd);q=Xd.prototype;q.isAvailable=function(){if(!this.h)return!1;try{return this.h.setItem("__sak","1"),this.h.removeItem("__sak"),!0}catch(a){return!1}};
...
q.C=function(a){var b=0,c=this.h,d=new Nc;d.next=function(){if(b>=c.length)throw Mc;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
q.clear=function(){this.h.clear()};
q.key=function(a){return this.h.key(a)};function Yd(){var a=null;try{a=window.localStorage||null}catch(b){}this.h=a}
...
q=Zd.prototype;q.isAvailable=function(){return!!this.h};
q.set=function(a,b){this.h.setAttribute(be(a),b);ce(this)};
q.get=function(a){a=this.h.getAttribute(be(a));if("string"!==typeof a&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
q.remove=function(a){this.h.removeAttribute(be(a));ce(this)};
q.C=function(a){var b=0,c=this.h.XMLDocument.documentElement.attributes,d=new Nc;d.next=function(){if(b>=c.length)throw Mc;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
q.clear=function(){for(var a=this.h.XMLDocument.documentElement,b=a.attributes.length;0<b;b--)a.removeAttribute(a.attributes[b-1].nodeName);ce(this)};
...
function If(a){var b={client:{hl:a.Da,gl:a.Ca,clientName:a.Ba,clientVersion:a.innertubeContextClientVersion,configInfo:a.Aa}},c=z.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=S("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=S("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=S("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!T("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=Of()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!T("music_web_display_mode_killswitch")){var h;b.client.ma=null!=(h=b.client.ma)?h:{};b.client.ma.webDisplayMode=Of()}a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);
S("DELEGATED_SESSION_ID")&&!T("pageid_as_header_web")&&(b.user={onBehalfOfUser:S("DELEGATED_SESSION_ID")});a:{if(h=Rf()){a=Pf[h.type||"unknown"]||"CONN_UNKNOWN";h=Pf[h.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==h&&(a=h);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==h){a=h;break a}}a=void 0}a&&(b.client.connectionType=a);T("web_log_effective_connection_type")&&(a=Rf(),a=null!==a&&void 0!==a&&a.effectiveType?Qf.hasOwnProperty(a.effectiveType)?Qf[a.effectiveType]:
...
q=Fg.prototype;q.add=function(a,b,c){return Gg(this,[a],{mode:"readwrite",D:!0},function(d){return Hg(d,a).add(b,c)})};
q.clear=function(a){return Gg(this,[a],{mode:"readwrite",D:!0},function(b){return Hg(b,a).clear()})};
q.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
q.count=function(a,b){return Gg(this,[a],{mode:"readonly",D:!0},function(c){return Hg(c,a).count(b)})};
function Ig(a,b,c){a=a.h.createObjectStore(b,c);return new Jg(a)}
q.delete=function(a,b){return Gg(this,[a],{mode:"readwrite",D:!0},function(c){return Hg(c,a).delete(b)})};
q.get=function(a,b){return Gg(this,[a],{mode:"readonly",D:!0},function(c){return Hg(c,a).get(b)})};
...
function Gg(a,b,c,d){return J(a,function f(){var g=this,h,k,l,m,n,r,p,y,C,A,Q,R;return x(f,function(E){switch(E.h){case 1:var N={mode:"readonly",D:!1};"string"===typeof c?N.mode=c:N=c;h=N;g.transactionCount++;k=h.D?Ie("ytidb_transaction_try_count",1):1;l=0;case 2:if(m){E.u(3);break}l++;n=Math.round(U());pa(E,4);r=g.h.transaction(b,h.mode);N=new Lg(r);N=Mg(N,d);return w(E,N,6);case 6:return p=E.i,y=Math.round(U()),Ng(g,n,y,l,void 0,b.join(),h),E.return(p);case 4:C=qa(E);A=Math.round(U());Q=vg(C,g.h.name,
b.join());if((R=Q instanceof V&&!Q.h)||l>=k)Ng(g,n,A,l,Q,b.join(),h),m=Q;E.u(2);break;case 3:return E.return(Promise.reject(m))}})})}
...
q=Jg.prototype;q.add=function(a,b){return X(this.h.add(a,b))};
...
q.delete=function(a){return a instanceof IDBKeyRange?Pg(this,a):X(this.h.delete(a))};
q.get=function(a){return X(this.h.get(a))};
q.index=function(a){return new Rg(this.h.index(a))};
...
Rg.prototype.count=function(a){return X(this.h.count(a))};
Rg.prototype.delete=function(a){return Tg(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
Rg.prototype.get=function(a){return X(this.h.get(a))};
Rg.prototype.getKey=function(a){return X(this.h.getKey(a))};
...
q=Ug.prototype;q.advance=function(a){this.cursor.advance(a);return Sg(this.request)};
q.continue=function(a){this.cursor.continue(a);return Sg(this.request)};
q.delete=function(){return X(this.cursor.delete()).then(function(){})};
q.getKey=function(){return this.cursor.key};
q.update=function(a){return X(this.cursor.update(a))};function Vg(a,b,c){return new Promise(function(d,e){function f(){r||(r=new Fg(g.result,{closed:n}));return r}
var g=self.indexedDB.open(a,b),h=c.blocked,k=c.blocking,l=c.Ja,m=c.upgrade,n=c.closed,r;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&ig("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:mg(a)});var y=f(),C=new Lg(g.transaction);m&&m(y,p.oldVersion,p.newVersion,
...
function fh(a,b,c,d){var e;return J(this,function g(){var h,k;return x(g,function(l){switch(l.h){case 1:return w(l,gh({caller:"openDbImpl",publicName:a,version:b}),2);case 2:return lg(a),h=c?{actualName:a,publicName:a,userIdentifier:void 0}:eh(a),h.clearDataOnAuthChange=null!==(e=d.clearDataOnAuthChange)&&void 0!==e?e:!1,pa(l,3),w(l,$g(h),5);case 5:return w(l,Wg(h.actualName,b,d),6);case 6:return l.return(l.i);case 3:return k=qa(l),pa(l,7),w(l,ah(h.actualName),9);case 9:l.h=8;l.s=0;break;case 7:qa(l);
case 8:throw k;}})})}
...
;function lh(a,b){Yg.call(this,a,b);this.options=b;lg(a)}
v(lh,Yg);lh.prototype.i=function(a,b,c){c=void 0===c?{}:c;return(this.options.ra?ih:hh)(a,b,Object.assign(Object.assign({},c),{clearDataOnAuthChange:this.options.clearDataOnAuthChange}))};
lh.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.ra?kh:jh)(this.name,a)};
function mh(a){var b;return function(){b||(b=new lh("LogsDatabaseV2",a));return b}}
;function nh(){W.call(this,function(){});
throw Error("Not allowed to instantiate the thennable outside of the core library.");}
v(nh,W);nh.reject=W.reject;nh.resolve=W.resolve;nh.all=W.all;var oh;function ph(){if(!oh){var a={};oh=mh({oa:(a.LogsRequestsStore=!0,a.sapisid=!0,a.SWHealthLog=!0,a),ra:!T("nwl_use_ytidb_partitioning"),upgrade:function(b,c){2>c&&(Ig(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).h.createIndex("newRequest",["status","authHash","interface","timestamp"],{unique:!1}),Ig(b,"sapisid"));3>c&&Ig(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:3})}return oh().open()}
function qh(a){return J(this,function c(){var d,e,f,g,h;return x(c,function(k){switch(k.h){case 1:return d={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(k,rh(),2);case 2:return e=k.i,w(k,ph(),3);case 3:return f=k.i,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:e,interface:S("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(k,Kg(f,g),4);case 4:return h=k.i,d.Ka=U(),sh(d),k.return(h)}})})}
function th(){return J(this,function b(){var c,d,e,f,g,h,k,l;return x(b,function(m){switch(m.h){case 1:return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(m,rh(),2);case 2:return d=m.i,e=S("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=["NEW",d,e,0],g=["NEW",d,e,U()],h=IDBKeyRange.bound(f,g),w(m,ph(),3);case 3:return k=m.i,l=void 0,w(m,Gg(k,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(n){return Tg(Hg(n,"LogsRequestsStore").index("newRequest"),{query:h,direction:"prev"},function(r){r.cursor.value&&
(l=r.cursor.value,l.status="QUEUED",r.update(l))})}),4);
case 4:return c.Ka=U(),sh(c),m.return(l)}})})}
function uh(a){return J(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,ph(),2);d=e.i;return e.return(Gg(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(f){var g=Hg(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",X(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function vh(a){return J(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,ph(),2);d=e.i;return e.return(Gg(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(f){var g=Hg(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,X(g.h.put(h,void 0)).then(function(){return h})):nh.resolve(void 0)})}))})})}
function wh(a){return J(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,ph(),2);d=e.i;return e.return(d.delete("LogsRequestsStore",a))})})}
...
q=Y.prototype;q.J=function(){this.l||this.h===this.Z()||ne(new jg("NetworkStatusManager isOnline does not match window status"));return this.h};
q.Ia=function(a){this.j=!0;if(void 0===a?0:a)this.V||Fh(this)};
...
function Mf(a,b,c,d){function e(r){r=void 0===r?!1:r;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(r||(p=Yf(b,c,l,k)),p)){var y=g.onSuccess,C=g.onFetchSuccess;g.onSuccess=function(A,Q){Zf(p);y(A,Q)};
c.onFetchSuccess=function(A,Q){Zf(p);C(A,Q)}}try{r&&d.retry&&!d.na.bypassNetworkless?(g.method="POST",!d.na.writeThenSend&&T("nwl_send_fast_on_unload")?Th(n,g):Nh(n,g)):(g.method="POST",g.postParams||(g.postParams={}),Ye(n,g))}catch(A){if("InvalidAccessError"==A.name)p&&(Zf(p),p=0),ne(Error("An extension is blocking network request."));
else throw A;}p&&Ke(function(){$f(a)},5E3)}
...
q=Ai.prototype;q.setSize=function(a,b){this.h.width=a.toString();this.h.height=b.toString();return this};
q.ta=function(){return this.h};
q.ga=function(a){Bi(this,a.event,a)};
...
"Unknown Error";h=l.name||"UnknownError";var m=l.stack||e.i||"Not available";if(m.startsWith(h+": "+f)){var n=m.split("\n");n.shift();m=n.join("\n")}n=l.lineNumber||"Not available";l=l.fileName||"Not available";var r=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(r=gi(e.args[g],"params."+g,k,r),500<=r);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var y="params."+g,C=ii(p[g]);k[y]=C;r+=y.length+
C.length;if(500<r)break}}else k.params=ii(p)}if(ni.length)for(g=0;g<ni.length&&!(r=gi(ni[g],"params.context."+g,k,r),500<=r);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:n,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=ci();f=u(e.K);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.ab)){e=h.weight;
break a}e=u(e.I);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.va(g)){e=f.weight;break a}e=1}g.sampleWeight=e;e=g;g=u(Yh);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.fa[e.name])for(n=u(f.fa[e.name]),h=n.next();!h.done;h=n.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];n=l.groups;l={};for(m=0;m<n.length;m++)l[n[m]]=h[m+1],e.params["params.error."+n[m]]=h[m+1];e.message=f.la(l);break}e.params||(e.params={});g=ci();e.params["params.errorServiceSignature"]=
...
value:h}),l.kvPairs.push({key:"server.version",value:m}));f={errorMetadata:l,stackTrace:n,logMessage:f}}f&&(Xh("clientError",f),("ERROR"===g||T("errors_flush_gel_always_killswitch"))&&Ef())}if(!T("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:S("PAGE_NAME",window.location.href),file:f.fileName},method:"POST"};g.version&&(d["client.version"]=g.version);if(d.postParams){f.stack&&
...
v(Ji,Ai);q=Ji.prototype;q.ia=function(){var a=Z(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.i,"embedConfig")){if(D(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
q.ga=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(D(a))for(var c in a)a.hasOwnProperty(c)&&(this.F[c]=a[c]);break;case "infoDelivery":Ki(this,a);break;case "initialDelivery":D(a)&&(window.clearInterval(this.j),this.playerInfo={},this.F={},Li(this,a.apiInterface),Ki(this,a));break;default:Bi(this,b,a)}};
...
q.getOptions=function(a){return this.F.namespaces?a?this.F[a]?this.F[a].options||[]:[]:this.F.namespaces||[]:[]};
q.getOption=function(a,b){if(this.F.namespaces&&a&&b&&this.F[a])return this.F[a][b]};
